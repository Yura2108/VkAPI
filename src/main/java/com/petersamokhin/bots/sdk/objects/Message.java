...
public class Message {
    ...
    /**
     * Attachments in format of received event from com.petersamokhin.bots.sdk.longpoll server
    ...
    /**
     * @param photos JSONArray with photo com.petersamokhin.bots.sdk.objects
