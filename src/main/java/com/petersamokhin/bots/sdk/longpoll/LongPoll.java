...
/**
 * com.petersamokhin.bots.sdk.Main class for work with VK com.petersamokhin.bots.sdk.longpoll server
...
public class LongPoll {
    ...
    /**
     * If true, all updates from com.petersamokhin.bots.sdk.longpoll server
    ...
    public LongPoll(Client client) {
        ...
        while (!dataSetted) {
            LOG.error("Some error occured when trying to get com.petersamokhin.bots.sdk.longpoll settings, aborting. Trying again in 1 sec.");
            try {
                Thread.sleep(1000);
    ...
    /**
     * If you need to set new com.petersamokhin.bots.sdk.longpoll server, or restart listening
     * off old before.
     */
    public void off() {
        longpollIsOn = false;
    ...
    /**
     * First getting of com.petersamokhin.bots.sdk.longpoll server params
     *
    ...
    private GetLongPollServerResponse getLongPollServer(String access_token) {
        ...
        try {
            ...
            LOG.error("Bad responce of getting com.petersamokhin.bots.sdk.longpoll server.");
            return null;
        }
        ...
        if (!response.has("response") || !response.getJSONObject("response").has("key") || !response.getJSONObject("response").has("server") || !response.getJSONObject("response").has("ts")) {
            LOG.error("Bad response of getting com.petersamokhin.bots.sdk.longpoll server!\nQuery: {}\n Response: {}", query, response);
            return null;
        }
    ...
    /**
     * Listening to events from VK com.petersamokhin.bots.sdk.longpoll server
     * and call com.petersamokhin.bots.sdk.callbacks on events.
    ...
    private void startListening() {
        ...
        while (longpollIsOn) {
            ...
            try {
                ...
                LOG.error("Some error occured, no updates got from com.petersamokhin.bots.sdk.longpoll server: {}", responseString);
                try {
                    Thread.sleep(1000);
